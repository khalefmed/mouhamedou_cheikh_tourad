...
export default function HomeSection(props){
    ...
    return (
        <main className=" h-[25em] -mt-24 bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url('/1.jpg')] bg-cover text-white flex justify-start align-center lg:px-20 md:px-16 xs:px-8  "  >
