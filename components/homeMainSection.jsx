...
export default function HomeMainSection(props){
    ...
    return (
        <main className=" h-screen -mt-24 lg:bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url('/tourad_bg_image.jpg')] xs:bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url('/Tourad_image.jpg')] bg-cover text-white flex justify-start xs:text-center md:text-start align-center lg:px-28 md:px-20 xs:px-2 "  >
