...
export default function ExperiencesListComponent(props){
                ...
                whileInView = {{
                 ...
                 className=' actualite shadow-2xl flex flex-col justiyf-center align-center gap-2 py-2 px-2 rounded-lg w-[21rem] '>
                    ...
                    <div className='px-3 py-3 flex flex-col gap-2'>
                        ...
                        {/* <Link href={`/experiences`} className='text-primaryColor font-semibold text-start w-full-5 my-2 text-lg'>{props.seeMore} </Link> */}
                    </div>
                </motion.div>
            })}
