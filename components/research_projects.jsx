...
export default function ResearchProjects (props){
  ...
  return (
    <section className=' py-12' id="projects">
        ...
        className={`section-title text-center lg:text-4xl md:text-3xl xs:text-2xl text-primaryColor font-bold mt-12 md:mb-20 xs:mb-10 uppercase ${props.isArabic ? '' : 'tracking-[1rem] xs:tracking-[0.5rem]'} ` }>Research Projects</motion.h1>
